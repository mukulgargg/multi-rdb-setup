...
public class ApplicationDetails_primary implements Serializable {
	...
	public interface BuildStep {
		ApplicationDetails_primary build();
	}
	...
	public static class Builder
		...
		public static StudentIdStep applicationDetails_primary() {
			return new Builder();
		}
		...
		@Override
		public ApplicationDetails_primary build() {
			return new ApplicationDetails_primary(
				this.studentId,
				this.fileData,
				this.createdDate,
				this.isActivate,
